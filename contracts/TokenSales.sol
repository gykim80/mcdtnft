...
contract TokenSales {
  ...
  function setForSales(uint256 _tokenId, uint256 _price) public
  {
  ...
  function perchaseToken(uint256 _tokenId) public payable {
  ...
  function removeTokenOnSale(uint256[] memory tokenIds) public{
      require(tokenIds.length > 0, "token is empty");  
